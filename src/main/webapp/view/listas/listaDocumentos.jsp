...
<body>
    ...
    <aside id = "menu_lateral">
        <ul id="menu_opciones">
            ...
            <li>
                <a href="<%=Constantes.VentanasJSP.URL_LISTA_DOCUMENTOS%>" style = "background-color: rgba(44, 82, 52, 1)">
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                <a <%=base.conteoAlumnos(per.getId_teacher()) == 0 ? 
                                        ...
                                        "" %> href = "<%=Constantes.Servlets.SERVLET_GENERAR_REPORTES%>?Attendance=<%=per.getId_teacher()%>&c=<%=per.getClassroom_teacher()%>" title="Ver bitacoras de Asistencia" target="_blank">
                            ...
                            <td>
                                <a <%=base.conteoAlumnos(per.getId_teacher()) == 0 ? 
                                        "style = 'pointer-events: none; color:gray'": 
                                        "" %> href = "<%=Constantes.Servlets.SERVLET_GENERAR_REPORTES%>?Payment=<%=per.getId_teacher()%>&c=<%=per.getClassroom_teacher()%>" title="Ver lista de Seguimiento de Pago" target="_blank">
                            ...
                            <td>
                                <a <%=base.conteoAlumnos(per.getId_teacher()) == 0 ? 
                                        "style = 'pointer-events: none; color:gray'": 
                                        "" %> href = "<%=Constantes.Servlets.SERVLET_GENERAR_REPORTES%>?Grade=<%=per.getId_teacher()%>&c=<%=per.getClassroom_teacher()%>" title="Ver lista de calificaciones" target="_blank">
