    ...
    <article>
        <div id = "perfil_usuario">
            <div class="form-container2">
                ...
                <table id = "tablaSeguimiento" class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <form class = "form" id = "formUpdateGrade" action = "<%=Constantes.Servlets.SERVLET_ACTUALIZAR_CALIFICACIONES%>" method = "post">
                                ...
                                <td>
                                    <input type="number" name="secondPartial" id="secondPartial" step = "0.1" min = "0" max = 10 value = "<%=per.getSecond_partial_report()%>"> 
                                </td> 
                                <td>
                                    <%=per.getAvg_report()%>
                                </td>
                ...
                <div class = "options">
                    <div id = "modificar">
                        <button type = "button" name = "update" id ="update" onclick="showAlertUpdateGrade()">
