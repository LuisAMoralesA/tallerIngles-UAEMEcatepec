...
<html lang = "es">
    <head>
        ...
        <title> <%=Constantes.Titulos.TITULO_LOGIN_TEACHER%> </title>
    ...
    <body class = "body-teacher">  
            ...
            <div class="menu container">
                ...
                <nav class = "navbar">
                    <ul>
                        ...
                        <li> 
                            <a href="<%=Constantes.VentanasJSP.URL_LOGIN_TEACHER%>" style = "color: rgb(255, 213, 1)"> Profesores </a>  
                        </li>
                        <li> 
        ...
        <main>               
            ...
            <div class="contenedor_login_register1">
                ...
                %>
                    <%@include file = "../sweetAlert/ventanaError.jsp"%>
            </div> 
        </main>
