...
<head>
    ...
    <title><%=Constantes.Titulos.TITULO_ACTUALIZAR_INFORMACION%> </title>
    ...
    <link rel = "stylesheet" href = "<%=Constantes.EstilosCSS.URL_CSS_ACTUALIZAR_INFO%>">
    ...
    <article>
        <div id = "perfil_usuario">
            <div class="form-container1">
                <form id = "formUpdateInformation" action="<%=Constantes.Servlets.SERVLET_ACTUALIZAR_INFORMACION%>" method="post">
                ...
                <div id = "button">
                    <div id = "modificar"> 
                        <button type = "button" name = "update" id ="update" onclick = "showAlertUpdateInformation()">
